...
# Compile the java file (assuming Subscriber1.java is your Java file)
RUN javac subscriber1.java

# Command to run the java class with arguments
CMD ["java", "subscriber1", "c-subscriber_01-Economic Indicators,Global Events"]
